...
export const KpiDashboard: React.FC = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, p: { xs: 2, md: 3 }, bgcolor: "#f8fafc", minHeight: "100vh" }}>
      ...
      {/* 1. MAIN PAGE HEADING & SUBTITLE AT TOP */}
      <Box sx={{ mb: 2.5 }}>
        <Typography variant="h4" sx={{ fontWeight: 800, color: "primary.main", letterSpacing: "-0.02em", fontSize: { xs: "1.35rem", sm: "1.6rem" } }}>
          Production & Traceability Overview
        </Typography>
        <Typography variant="body2" sx={{ color: "#475569", fontWeight: 500, mt: 0.5, fontSize: "0.88rem" }}>
